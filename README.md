<h1 align="center"> :joystick: Rescue Game :game_die:	</h1> 
<p align="center"> 🚀 Projeto desenvolvido durante os estudos de HTML, CSS e Javascript do bootcamp Orbi Game Developer, na Digital Inovation One. Também foi utilizado Jquery no projeto. O jogo consiste no controle de uma nave que tem por objetivo resgatar os soldados evitando a colisão com os outros elementos da tela, como outras naves ou o carro. Ele foi feito para ser pensado em uma pessoa, se encontra funcional mas ainda não completamente pronto, o código será revisado e melhorado em breve. </p>
